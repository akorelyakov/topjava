...
public class JdbcUserRepository implements UserRepository {
    ...
    public User get(int id) {
        return addRolesToUser(jdbcTemplate.query("SELECT * FROM users WHERE id=?", ROW_MAPPER, id));
    }

    @Override
    public User getByEmail(String email) {
        return addRolesToUser(jdbcTemplate.query("SELECT * FROM users WHERE email=?", ROW_MAPPER, email));
    }
    ...
    private User addRolesToUser(List<User> users) {
