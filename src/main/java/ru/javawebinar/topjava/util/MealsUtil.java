...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay,
                                              ...
                                              LocalTime endTime) {
        return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenClose(meal.getDate(),
                startDate, endDate) && DateTimeUtil.isBetweenHalfOpen(meal.getTime(),
                startTime, endTime));
    }
